...
if (isset($_GET['kategori_id'])) {
    ...
    if (!count($d)) {
        echo "<script>alert('Data tbuku_idak ditemukan pada database');window.location='kategori.php';</script>";
    }
} else {
            ...
            <div class="col">
                <div class="bg-success rounded h-100 p-4">
                    ...
                    <form method="POST" action="proses_update_kategori.php">
                        <div class="row mb-3">
                            <label for="inputText3" class="col-sm-2 col-form-label">ID KATEGORI</label>
                            <div class="col-sm-10">
